...
cxi32 cx_font_render_word_wrap (const cx_font *font, const char *text, cxf32 x, cxf32 y, cxf32 bx, cxf32 by, cx_font_alignment alignment, const cx_colour *colour);
