...
{
  cxu8 byte0 = (cxu8) (val >> 8);
  cxu8 byte1 = (cxu8) (val << 8);
  
  cxu16 swap = byte0 | byte1;
...
{
  cxu8 byte0 = (cxu8) ((val >> 24));
  cxu8 byte1 = (cxu8) ((val << 8)  & 0x00ff0000);
  cxu8 byte2 = (cxu8) ((val >> 8)  & 0x0000ff00);
  cxu8 byte3 = (cxu8) ((val << 24));
  
  cxu32 swap = byte0 | byte1 | byte2 | byte3;
