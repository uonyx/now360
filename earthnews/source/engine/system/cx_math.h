...
static CX_INLINE cxi32 cx_roundupInt (cxf32 x);
static CX_INLINE cxu32 cx_roundupPow2 (cxu32 x);
...
static CX_INLINE static CX_INLINE cxi32 cx_roundupInt (cxf32 x)
{
  cxf32 f = x + 0.5f;
  cxi32 i = (cxi32) f;
